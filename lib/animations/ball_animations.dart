...
class _HomPageState extends State<HomPage>  with SingleTickerProviderStateMixin{
  ...
  void initState() {
    ...
    super.initState();
    _animatedContainer = AnimationController(vsync: this, duration: const Duration(milliseconds: 500));
    ...
    ).animate(CurvedAnimation(parent: _animatedContainer, curve: const Interval(0.0,1.0,curve: Curves.easeIn))
    );
            ...
            Center(
              child: AnimatedBuilder(
                ...
                builder:  (cth, ch) => Container(
                    ...
                    child: Icon(Icons.sports_baseball, size: 100,)
                ),
              ),
            ),
